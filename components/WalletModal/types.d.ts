...
export declare type ConnectWalletModalProps = Omit<WalletModalProps, "fontFamily" | "onConnect">;
export declare type DisconnectWalletModalProps = Omit<WalletModalProps, "fontFamily" | "onConnect">;
