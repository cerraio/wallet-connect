...
var useConnectWallet = function useConnectWallet() {
  ...
  var _useState = (0, _react.useState)(localStorage.getItem(_common.storageKey)),
    _useState2 = _slicedToArray(_useState, 2),
    initialWalletName = _useState2[0],
    setInitialWalletName = _useState2[1];
  ...
  var getEnabledWallet = (0, _react.useCallback)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    var isWalletConnected, enabledWallet;
   ...
   */
  (0, _react.useEffect)(function () {
    var updateInitialWalletName = function updateInitialWalletName() {
      var walletName = localStorage.getItem(_common.storageKey);
      setInitialWalletName(walletName);
    };
    window.addEventListener(_common.storageKey, updateInitialWalletName);
    return function () {
      window.removeEventListener(_common.storageKey, updateInitialWalletName);
    };
  }, []);
  return {
